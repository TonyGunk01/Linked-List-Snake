...
namespace UI
{
    namespace LinkedListUI
    {
        ...
        void LinkedListSelectionUIController::initializeButtons()
        {
            ...
            single_linked_list_button->initialize("Single Linked List Button", Config::single_linked_list_button_texture_path, button_width, button_height, Vector2f(x_position, single_linked_list_button_y_position));
            double_linked_list_button->initialize("Double Linked List Button", Config::double_linked_list_button_texture_path, button_width, button_height, Vector2f(x_position, double_linked_list_button_y_position));
        ...
        {
            single_linked_list_button->registerCallbackFuntion(bind(&LinkedListSelectionUIController::singleLinkedListButtonCallback, this));
            double_linked_list_button->registerCallbackFuntion(bind(&LinkedListSelectionUIController::doubleLinkedListButtonCallback, this));
            menu_button->registerCallbackFuntion(bind(&LinkedListSelectionUIController::menuButtonCallback, this));
        }
