...
namespace UI
{
    namespace GameplayUI
    {
        ...
        {
            level_number_text->initialize("Level : 1", Vector2f(level_number_text_x_position, text_y_position), FontType::BUBBLE_BOBBLE, font_size, Color::Black);
        }

        void GameplayUIController::initializeScoreText()
        {
            score_text->initialize("Score : 0", Vector2f(score_text_x_position, text_y_position), FontType::BUBBLE_BOBBLE, font_size, Color::Black);
        }

        void GameplayUIController::initializeTimeComplexityText()
        {
            time_complexity_text->initialize("Time Complexity : O(1)", Vector2f(time_complexity_text_x_position, time_complexity_text_y_position), FontType::BUBBLE_BOBBLE, operations_font_size, Color::Black);
        }

        void GameplayUIController::initializeOperationText()
        {
            operation_text->initialize("Last Operation : Insert at Middle", Vector2f(operations_text_x_position, operations_text_y_position), FontType::BUBBLE_BOBBLE, operations_font_size, Color::Black);
        }
        ...
        void GameplayUIController::updateLevelNumberText()
        {
            ...
            String level_number_value = to_string(1 + static_cast<int>(level_number));
        ...
        void GameplayUIController::updateScoreText()
        {
            ...
            String score_value = to_string(player_score);
